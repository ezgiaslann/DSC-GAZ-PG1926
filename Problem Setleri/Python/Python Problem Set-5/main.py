...
okul_1 = Sinif("Selma Yiğitalp Anadolu Lisesi", 100,20 ,["fen","sosyal"], 5)                       
okul_2= Sinif("60. Yıl Anadolu Lisesi", 200, 50, ["fen","sosyal"],3)
okul_3 = Sinif("Bornova Anadolu Lisesi", 150, 40, ["fen","sosyal"],5)
